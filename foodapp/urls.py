from foodapp.forms import LoginForm, PasswordChangeForm, PasswordResetForm, SetPasswordForm
...
urlpatterns = [
    ...
    path('accounts/logout/', auth_views.LogoutView.as_view(next_page='foodapp:login'), name="logout"),
