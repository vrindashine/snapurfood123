...
from foodapp.models import Address
...
class AddressForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {'locality':forms.TextInput(attrs={'class':'form-control', 'placeholder':'your address'}), 'city':forms.TextInput(attrs={'class':'form-control', 'placeholder':'City'}), 'state':forms.TextInput(attrs={'class':'form-control', 'placeholder':'State or Province'})}
